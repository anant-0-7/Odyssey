...
export default function Home() {
  return (
    <>
      ...
      {/* Main Section */}
      <div className="relative w-full h-screen bg-[#FDFEC4] flex flex-col items-center overflow-hidden">
        {/* Left SVG (Flipped) - Hidden on small screens */}
        <img
          src={tree}
          alt="Left SVG"
          className="absolute left-0 top-0 h-full transform scale-x-[-1] hidden md:block z-20"
        />
