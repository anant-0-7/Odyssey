...
const Description = () => (
    <div className="py-16">
        <div className="flex flex-col justify-center">
            <div className="py-20">
                <h1 className="text-4xl font-extrabold text-[#AD3535] text-center">
                    Secure Your Spot At Odyssey!
                </h1>
            </div>
            <div className="flex flex-col justify-center px-20 py-4">
                <h1 className="text-3xl font-semibold text-[#AD3535] text-center py-10 mx-32">
    ...
    return (
        <div className="bg-[#FDFEC4] min-h-screen">
            ...
            <div className="flex justify-center items-center flex-col gap-8 py-3">
                <button className="bg-[#AD3535] w-80 py-8 text-center rounded-3xl text-white font-bold">DAY 1 Passes</button>
                <button className="bg-[#AD3535] w-80 py-8 text-center rounded-3xl text-white font-bold">DAY 2 Passes</button>
                <button className="bg-[#AD3535] w-80 py-8 text-center rounded-3xl text-white font-bold">Other exclusive passes</button>
            </div>
            <Description />
